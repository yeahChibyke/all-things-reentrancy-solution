...
contract ProofOfConcept is Test {
    ...
    function setUp() public {
        ...
        console.log(
            "[>] Initial pool state: %s eth, %s stEth | Spotprice %s",
    ...
    function test_exploit() public {
        ...
        console.log("--------------------------------------------------------");
        console.log(
            unicode"| => Attacker's added balance 👀 %s (ETH + stETH) 👀",
            toEth(address(attacker).balance + stEth.balanceOf(address(attacker)))
        );
        console.log(
            unicode"|       %s ETH | %s stETH",
